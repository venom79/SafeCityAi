...
export default function StepCaseDetails() {
  ...
  const handleNext = async () => {
    ...
    const success = await saveCaseDetails()
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div>
        ...
        <p className="text-sm sm:text-base text-gray-600">
          Provide information about when and where the person was last seen
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="sm:col-span-2 space-y-2">
          ...
          <p className="text-xs text-gray-500">
            Include any relevant details about circumstances, witnesses, or important information
          </p>
        </div>
