...
export default function StepComplainant() {
  const { complainant, setComplainant, setStep, saveDraft } = useCaseForm()
  ...
  const field = (key, label, props = {}) => (
    <div className="space-y-2">
      ...
      <Input
        ...
        onChange={(e) => setComplainant({ ...complainant, [key]: e.target.value })}
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {field("full_name", "Full Name", { placeholder: "Enter full name", required: true })}
        {field("phone", "Phone Number", { placeholder: "+91 XXXXX XXXXX", required: true })}
        {field("email", "Email (Optional)", { placeholder: "example@email.com", type: "email" })}
        ...
        {field("age", "Age", { placeholder: "Enter age", type: "number", required: true })}
        {field("relation", "Relationship with Person", { placeholder: "e.g., Father, Mother, Sibling", required: true })}
        {field("aadhaar", "Aadhaar Number", { placeholder: "XXXX XXXX XXXX", required: true })}
