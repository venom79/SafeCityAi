    ...
    <div className="space-y-6 sm:space-y-8">
          ...
          <div className="p-4 sm:p-6 space-y-4 bg-white">
            ...
            <div
              className={`border-2 border-dashed rounded-lg p-6 sm:p-8 text-center transition-colors cursor-pointer
                ${dragActive ? "border-black bg-gray-50" : "border-gray-300 hover:border-black hover:bg-gray-50"}`}
            ...
            >
              ...
              <input
                ...
                onChange={(e) => {
                  if (e.target.files) addPhotos(Array.from(e.target.files), personIndex)
                }}
              />
      ...
      <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-4 sm:p-6">
        <div className="flex items-start gap-3">
          <Checkbox id="agree" checked={agree} onCheckedChange={setAgree} className="mt-1" />
